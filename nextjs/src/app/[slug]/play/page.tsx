...
export default async function VideoPlayPage({ params }: { params: { slug: string } }) {
    ...
    <main className="container mx-auto px-4 py-6">
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1">
          ...
          <h2 className="mt-4 text-2xl font-bold text-primary">{video.title}</h2>

          <div className="mt-2 flex items-center justify-between text-secondary">
            <div className="flex flex-row items-center">
              <Suspense fallback={<div className="w-48 h-8 bg-secondary animate-pulse rounded mr-2"></div>}>
            ...
            <Suspense fallback={<div className="w-24 h-8 bg-secondary animate-pulse rounded mr-2"></div>}>
        ...
        <div className="w-full md:w-1/3">
          <h3 className="text-xl font-semibold text-primary mb-4">Vídeos Recomendados</h3>
